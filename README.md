...
Project Overview
This project, developed by Darshini , focuses on analyzing and predicting the weekly sales performance of a retail chain with multiple outlets across the country. By leveraging historical data, the study explores how socio-economic and environmental factors—such as Unemployment Rates, Consumer Price Index (CPI), Fuel Prices, and Temperature—impact consumer behavior and store performance.
